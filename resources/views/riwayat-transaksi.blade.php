                    ...
                    <td class="px-5 py-3.5 text-center" onclick="event.stopPropagation();">
                        <div class="flex items-center justify-center gap-1.5">
                            ...
                            @if($t->bukti_pembayaran)
                                <a href="{{ url('/bukti-pembayaran/' . basename($t->bukti_pembayaran)) }}" target="_blank" class="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-semibold text-gray-600 bg-gray-50 hover:bg-gray-100 no-underline transition-all border border-gray-200">
