...
<div class="flex w-full">
    <aside id="sidebar" class="w-[260px] flex-shrink-0 bg-blue-50 flex flex-col z-10 border-r border-blue-200 shadow-[0_2px_4px_rgba(30,58,138,0.05)] transition-all duration-300 overflow-hidden">
        ...
        <ul class="px-4 py-6 flex-grow flex flex-col gap-2">
            <a href="{{ url('/admin/dashboard') }}" class="flex items-center px-5 py-3.5 rounded-xl font-medium transition-all duration-200 text-base {{ Request::is('admin/dashboard') ? 'bg-blue-100 text-blue-900 font-semibold' : 'text-slate-600 hover:bg-blue-100 hover:text-blue-900 hover:translate-x-1.5' }}">
